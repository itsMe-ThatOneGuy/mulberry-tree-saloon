			...
			<div>
				...
				>
					<div className="bg-black bg-opacity-60 h-screen flex flex-col justify-center items-center">
						<h1 className="text-white text-3xl font-bold uppercase tracking-[.2em] drop-shadow md:text-8xl">
							Mulberry <span className="text-green-500">Tree</span>
						</h1>
						<h1 className="text-white text-3xl font-bold uppercase tracking-[.2em] edrop-shadow pt-12 md:text-8xl">
							Saloon
						</h1>
					</div>
				</div>
